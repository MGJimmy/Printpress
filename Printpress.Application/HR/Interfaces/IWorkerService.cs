...
{
    Task<PagedList<WorkerDto>> GetAllAsync(Paging paging);
    ...
    Task<PagedList<WorkerProductionDto>> GetWorkerProduction(Guid id, Paging paging, DateTime? productionDateFrom, DateTime? productionDateTo);
